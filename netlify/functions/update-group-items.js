...
//
// Every line is re-priced against the live menu/extras/neighbors config (same trusted
...
const { PricingError, flattenPrices, priceCart } = require("./lib/pricing");
...
async function handler(event) {
  ...
  let orderItems;
  try {
    ({ orderItems } = priceCart(items, { menuPrices, extraPrices, soldOut, menuLoaded }));
  } catch (e) {
